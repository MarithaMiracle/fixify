...
import {
  Star, MapPin, Calendar, Wallet, User, FileText, LogOut, ClipboardList, ClipboardCheck, Users
} from 'lucide-react';
...
export default function UserDashboardPage() {
  const [activeSection, setActiveSection] = useState<
    'upcoming' | 'past' | 'saved' | 'wallet' | 'profile' | 'payment-history'
  >('upcoming');
  ...
  const upcomingBookings: Booking[] = [
    { id: 1, service: "Plumbing Repair", provider: "John Duru", date: "Aug 10, 2024", 
      time: "10:00 AM", status: "Confirmed", price: "₦12,500", address: "123 Main St, Lagos" },
    { id: 2, service: "Bridal Makeup", provider: "Sarah Adebayo", date: "Sep 01, 2024", 
      time: "09:00 AM", status: "Pending", price: "₦50,000", address: "456 Oak Ave, Abuja" },
  ];

  const pastBookings: Booking[] = [
    { id: 3, service: "Deep Cleaning", provider: "CleanPro Services", date: "Jul 05, 2024", 
      time: "02:00 PM", status: "Completed", price: "₦8,000", rating: 5 },
    { id: 4, service: "Laptop Repair", provider: "TechFix Solutions", date: "Jun 18, 2024", 
      time: "11:00 AM", status: "Completed", price: "₦15,000", rating: 4 },
  ];

  const savedProviders: Provider[] = [
    { id: 101, name: "Sarah Adebayo", category: "Makeup Artist", rating: 4.8, 
      image: "https://placehold.co/60x60/f3e5f5/9c27b0?text=SA" },
    { id: 102, name: "John Duru", category: "Plumber", rating: 4.9, 
      image: "https://placehold.co/60x60/dbeafe/1e40af?text=JD" },
  ];

  const paymentHistory: Payment[] = [
    { id: 201, date: "Jul 10, 2024", description: "Plumbing Repair (Booking #1)", 
      amount: "₦12,500", type: "Debit" },
    { id: 202, date: "Jun 20, 2024", description: "Wallet Top-up", 
      amount: "₦5,000", type: "Credit" },
    { id: 203, date: "Jun 05, 2024", description: "Deep Cleaning (Booking #3)", 
      amount: "₦8,000", type: "Debit" },
  ];

  // Profile form states
  const [profileName, setProfileName] = useState<string>(user.name);
  const [profileEmail, setProfileEmail] = useState<string>("jane.doe@example.com");
  const [profilePhone, setProfilePhone] = useState<string>("08012345678");
                    ...
                    <div className="flex flex-col items-start md:items-end gap-2">
                      ...
                      {booking.rating && (
                        <div className="flex items-center">
                          ...
                          {[...Array(5 - Math.ceil(booking.rating))].map((_, i) => (
            ...
            <div className="flex flex-col sm:flex-row items-center">
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs mt-1 font-inter">
                  User ID: <span className="font-mono text-gray-700">{user.uid}</span>
                </p>
              </div>
            </div>
