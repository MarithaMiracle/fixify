    ...
    return (
        <section className="relative bg-gradient-to-br from-orange-50 to-[#e9a473] py-20 md:py-32 flex items-center justify-center min-h-[60vh] mt-16 md:mt-0 overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-30">
                <div className="absolute w-64 h-64 bg-orange-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob top-10 left-10 md:w-96 md:h-96"></div>
                ...
                <div className="absolute w-64 h-64 bg-orange-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:w-96 md:h-96"></div>
            </div>
            ...
            <div className="container mx-auto px-6 text-center relative z-10">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <button className="bg-[#cc5500] text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-[#cc5500] transition-all duration-300 ease-in-out shadow-lg hover:shadow-xl transform hover:scale-105 font-inter">
                        Book a Service
                    </button>
